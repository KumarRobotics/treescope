#!/bin/bash
dataset_json='test-ucm-0523m.json'
...
f
  ...
  echo "128"
    ...
    # Record bag
    rosbag record -O "/derek_data/dataset/bags/$1/$3" /Odometry /tf /tf_static /os_node/segmented_point_cloud_no_destagger /tree_cloud /tree_cloud_world /ground_cloud /cloud_registered_body __name:=record_bag &
    sleep 1
